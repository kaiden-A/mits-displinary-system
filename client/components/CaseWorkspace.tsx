...
function requiredDocuments(caseData: CaseDetail) {
  ...
  return codes.map((code) => {
    ...
    return { id: code, code: item?.[1] || code.toUpperCase(), name: names[code] || item?.[2] || code, filled: existing.has(code) || (code === "b04" && !["REPORTED", "DISMISSED"].includes(caseData.status)) };
  });
}
